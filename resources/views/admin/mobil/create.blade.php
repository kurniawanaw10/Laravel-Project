                    ...
                    <form action="/admin/mobil" method="POST" enctype="multipart/form-data" class="m-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 mt-3">
                                ...
                                <input type="text" class="form-control @error('denda') is-invalid @enderror" id="denda" name="denda" value="{{ old('denda') }}">
                                @error('denda')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 mt-3">
                                ...
                                <input type="file" class="form-control-file @error('foto_mobil') is-invalid @enderror" id="image" name="foto_mobil">
                                @error('foto_mobil')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
